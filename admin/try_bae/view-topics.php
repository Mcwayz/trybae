        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Action /</span> View Topics</h4>

              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                      <a class="nav-link" href="create-topics.php"><i class="bx bx-plus me-1"></i> View Topics</a>
                    </li>
                    <li class="nav-item">
                  ...
                  <?php 
										...
										$result = $mysqli->query("SELECT * FROM topics") or die($mysqli->error);
									?>
