              ...
              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                      <a class="nav-link active" href="javascript:void(0);"><i class="bx bx-plus me-1"></i> Add Event</a>
                    </li>
                    <li class="nav-item">
                  ...
                  <div class="card mb-4">
                    ...
                    <hr class="my-0" />
                    <div class="card-body">
                      <form  method="POST" action="includes/event_controller.php" enctype="multipart/form-data">
                        <?php 
